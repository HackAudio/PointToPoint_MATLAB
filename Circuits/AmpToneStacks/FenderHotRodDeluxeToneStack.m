classdef FenderHotRodDeluxeToneStack < Circuit 
    
    methods
        function [o] = FenderHotRodDeluxeToneStack 
            
            o.layout.numNodes = 7;
            o.layout.Vin = VoltageInput(1,0);
            o.layout.Vout = VoltageOutput(4,0);
            
            R1 = Resistor(13e4,1,2);
            R2 = Resistor(22e4,5,0);
            o.layout.Rs = [R1; R2];
            
            C1 = Capacitor(250.0e-12,1,3);
            C2 = Capacitor(0.1e-6,2,5);
