classdef Order2ndActiveLPFClipper < Circuit 
    methods
        function [o] = Order2ndActiveLPFClipper()
            o.layout.numNodes = 5;
            ...
            R1 = Resistor(300e3,1,2);
            R2 = Resistor(300e3,2,3);
            R3 = Resistor(30e3,4,0);
