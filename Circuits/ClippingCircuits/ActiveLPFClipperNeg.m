classdef ActiveLPFClipperNeg < Circuit 
    methods
        function [o] = ActiveLPFClipperNeg()
            o.layout.numNodes = 4;
            ...
            r = 500e3;
            R1 = Resistor(50e3,1,2); % 50e3-100e3 ?
...
%             R3 = Resistor(9.1e3,3,4);
            ...
            D1 = Diode(Semiconductor.SILICON,Configuration.SINGLE,0,2);
            o.layout.Ds = [D1];
